...
Nineteen ADRs cover the decisions that are expensive to reverse: the original seven, four of them amended by the Decisions tab, plus three written with them (0008–0010), and nine added as the iterations shipped (0011–0019). The first ten are **Proposed**; 0011 onwards are **Accepted**, because they record what was built rather than what was intended.
