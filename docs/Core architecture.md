...
Ten ADRs cover the decisions that are expensive to reverse: the original seven, four of them amended by the Decisions tab, plus three new ones. All are **Proposed** until the v0.1 spikes confirm them.
